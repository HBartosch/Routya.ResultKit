...
namespace Routya.ResultKit.Attributes
{
    ...
    public class ValidDateTimeOffsetRangeAttribute : ValidationAttribute
    {
        private readonly string _endDateProperty;

        public ValidDateTimeOffsetRangeAttribute(string endDateProperty)
        {
        ...
        {
            var start = value as DateTimeOffset?;
            ...
            var end = prop.GetValue(validationContext.ObjectInstance) as DateTimeOffset?;
